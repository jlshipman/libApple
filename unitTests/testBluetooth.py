...
class blueTestCase(unittest.TestCase):
	print "Tests for `blue.py`."
	...
	def testBluetoothDisable(self):
		print "\ttestBluetoothDisable"
		retObj = blue.bluetoothDisable()
		resultDesired = 0
		result = retObj.getResult()
		retVal = retObj.getRetVal()
		comment = retObj.getComment()
	...
	def testGetDiscoverable(self):
		print "\ttestGetDiscoverable"
		retObj = blue.getDiscoverable()
		resultDesired = 0
		result = retObj.getResult()
		retVal = retObj.getRetVal()
		comment = retObj.getComment()
